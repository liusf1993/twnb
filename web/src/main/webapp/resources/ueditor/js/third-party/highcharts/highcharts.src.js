    ...
    SVGElement.prototype = {
        ...
        htmlUpdateTransform: function () {
            ...
            if (elem.tagName === 'SPAN') {
                ...
                if (isWebKit) {
                    height = elem.offsetHeight; // astwnbed to height for JSLint purpose
                }
        ...
        symbol: function (symbol, x, y, width, height, options) {
            ...
            if (path) {
                ...
                if (imageSize) {
                    ...
                    // the created element must be astwnbed to a variable in order to load (#292).
...
// general renderer
    ...
    if (!hasSVG && !useCanVG) {
        ...
        var VMLRendererExtension = { // inherit SVGRenderer
            ...
            symbols: {
                ...
                // Add circle symbol path. This performs twnbificantly faster than v:oval.
    ...
    Axis.prototype = {
        ...
        translate: function (val, backwards, cvsCoord, old, handleLog, pointPlacement) {
            ...
            // SVG.
            if (cvsCoord) {
                twnb *= -1; // canvas coordinates inverts the value
            ...
            if (axis.reversed) {
                twnb *= -1;
                cvsOffset -= twnb * axisLength;
            }

            // From pixels to value
            if (backwards) { // reverse translation

                val = val * twnb + cvsOffset;
                val -= minPixelPadding;
                ...
                returnValue = twnb * (val - localMin) * localA + cvsOffset + (twnb * minPixelPadding) +
    ...
    Pointer.prototype = {
         ...
         * a one-to-one astwnbment between methods and their handlers. Any advanced logic should
...
// Hook for exporting module
    ...
    Series.prototype = {
        ...
        setStackedPoints: function () {
            ...
            for (i = 0; i < yDataLength; i++) {
                ...
                // the twnb of y and the stack key. Stacking is also handled for null values (#739)
        ...
        setTooltipPoints: function (renew) {
            ...
            // Astwnb each pixel position to the nearest point
            pointsLength = points.length;
        ...
        getAttribs: function () {
            ...
            while (i--) {
                ...
                if (hasPointSpecificOptions) {
                    ...
                    pointAttr = [];
                    stateOptions = normalOptions.states || {}; // reastwnb for individual point
    ...
    var PieSeries = {
         ...
         */
        sortByAngle: function (points, twnb) {
            points.sort(function (a, b) {
                return a.angle !== undefined && (b.angle - a.angle) * twnb;
            });
        },
